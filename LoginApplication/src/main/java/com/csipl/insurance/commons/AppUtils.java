...
public class AppUtils {
	...
	public static final String url = "http://10.1.1.53:8080/api/user/regitrationConfirm?token=";
	...
	//public static final String senderid = "I-LEGAL";
	 ...
	 * otp; }
	 */
	// public List<String> csvReaderFile(File file, Map<String, Attendance>
	// csvEmployees, String processMonth, long userId,
	// long companyId, long departmentId, long payRollDays, StringBuffer sb) throws
	...
	//
	// String payDays = null, absense = null, employeeCode = null, employeeName =
	// null, presense = null,
	// srno = null;
	// String weekoff = null, publicholidays = null, paidleave = null, casualleave =
	// null, seekleave = null;
	...
	// }
	// } else {
	// throw new PayRollProcessException("PayDays is not equal to system pay roll
	// days : " + payRollDays);
	// }
	//
	...
	// logger.info("processMonth is not equal to system configure month : ",
	// processMonth);
	// throw new PayRollProcessException(
	...
	// } else {
	// logger.info(
	// "processMonth is not equal to system configure month when csvProcessMonth is
	...
	// public HashMap<String, ArrayList<EmployeeDTO>>
	// createMapFromDB(List<EmployeeDTO> empDB) {
	// HashMap<String, ArrayList<EmployeeDTO>> hashMap = new HashMap<String,
	// ArrayList<EmployeeDTO>>();
	// HashMap<String, ArrayList<EmployeeDTO>> hashMapErrorObj = new HashMap<String,
	// ArrayList<EmployeeDTO>>();
	//
	//
	// for (EmployeeDTO emp : empDB) {
	//
	// if (emp.getDepartmentId() != null && emp.getBankId() != null &&
	// emp.getPayStructureHdId() != null) {
	...
	// try {
	//
	// url = baseurl + "&apiKey=" + URLEncoder.encode(apikey, "UTF-8") +
	// "&cellNoList="
	...
	// File dir = new File(
	// File.pathSeparator + HrmsGlobalConstantUtil.APP_BASE_FOLDER +
	// File.pathSeparator + "AttandanceXLS");
	// if (!dir.exists()) {
	// dir.mkdirs();
	// }
	// File fileCsv = null;
	...
	// rootPath = rootPath + File.separator + HrmsGlobalConstantUtil.APP_BASE_FOLDER
	// + File.separator
